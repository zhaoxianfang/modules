...
class MakeModuleModelCommand extends ModuleGeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'module:make:model {module : 模块名称} {name : 模型名称} {--force : 覆盖现有文件}';
     ...
     * @var string
     */
    protected $description = '为模块创建新的模型';
    ...
    protected function getDestinationPath(string $moduleName, string $name): string
    {
        ...
        $modelPath = $this->getModulePath($moduleName) . '/Models/' . $modelName . '.php';

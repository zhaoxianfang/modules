...
class MakeModuleResourceCommand extends ModuleGeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'module:make:resource {module : 模块名称} {name : 资源类名称} {--force : 如果文件已存在，则强制覆盖}';
     ...
     * @var string
     */
    protected $description = '为模块创建新的资源类';
    ...
    {
        return $this->getModulePath($moduleName) . '/Http/Resources/' . $name . '.php';
    }

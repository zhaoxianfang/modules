...
class MakeModuleControllerCommand extends ModuleGeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'module:make:controller {module : 模块名称} {name : 控制器名称} {--force : 覆盖现有文件}';
     ...
     * @var string
     */
    protected $description = '为模块创建新控制器';
    ...
    protected function getDestinationPath(string $moduleName, string $name): string
    {
        ...
        $controllerPath = $this->getModulePath($moduleName) . '/Http/Controllers/' . $controllerName . '.php';
    ...
    {
        return $this->getStubPath('controller.stub');
    }
